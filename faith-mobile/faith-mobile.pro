...
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../sha512crypt/release/ -lsha512crypt
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../sha512crypt/debug/ -lsha512crypt
else:unix: LIBS += -L$$OUT_PWD/../sha512crypt/ -lsha512crypt

INCLUDEPATH += $$PWD/../sha512crypt
DEPENDPATH += $$PWD/../sha512crypt

win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../sha512crypt/release/libsha512crypt.a
else:win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../sha512crypt/debug/libsha512crypt.a
else:win32:!win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../sha512crypt/release/sha512crypt.lib
else:win32:!win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../sha512crypt/debug/sha512crypt.lib
else:unix: PRE_TARGETDEPS += $$OUT_PWD/../sha512crypt/libsha512crypt.a
